...
t = struct( ...
    ...
    'Contrast_variance_inflation_factors_interest_only',[], ...
    'wh_interest_only_columns',                         [], ...
    'Leverages',                                        [], ...
    'Cooks_distance',                                   [], ...
    'condition_number',                                 [], ...
    'condition_number_interest_only',                   [], ...
    'rank_deficient',                                   [], ...
    'collinearity_report',                              [], ...
    'efficiency',                                       [], ...
    'efficiency_per_contrast',                          [], ...
    'efficiency_contrast_names',                        [], ...
    'efficiency_contrast_source',                       [], ...
    'vif_threshold',                                    [], ...
    'cond_threshold',                                   []);
end
