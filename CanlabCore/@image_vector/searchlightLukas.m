...
output_val = cell(1, n);
voxlist = dat.volInfo.xyzlist;
not_removed = ~dat.removed_voxels;
xyzlist = voxlist(not_removed,:);
...
stats = [output_val{:}];
dat_temp = [stats.cverr]';
results_obj.dat = dat_temp;
...
function indx = faster_index(xyz, i, r)
seed = xyz(i,:);
