function output_obj = select_voxels_by_value(parcel_obj, indx)
% Given an fmri_data object and index values [integers], return an object
% with data values of 1 where voxel values match any index value, and 0
% otherwise. Esp. useful for selecting regions of interest from
% parcel/atlas images.
% 
% :Usage:
% ::
...
% Find voxels
wh_vox = any(objdat == indx_to_search, 2);
