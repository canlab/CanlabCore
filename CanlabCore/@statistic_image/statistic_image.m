% statistic_image Object class for statistical images (t/p/thresholded maps).
%
% An object that allows for storage and manipulation of images containing
% t-values, p-values, and thresholded results.
%
...
%
% The object constructor creates an object and populates it with data.
% Entering image name(s) loads in the data.
%
...
%
%   **properties:**
%        Any valid attribute/property of statistic_image, followed by
%        data values to store. See properties(statistic_image).
%
%   **image names:**
%        A character array with one or more filenames for Analyze/NIFTI
%        images (.img/nii).
%
% :Outputs:
%
