...
p.addParameter('MontageType', 'hcp', @(x) ischar(x) || isstring(x));  % passthrough to hrf_make_montage_animation (e.g. 'compact2' for fast volume render)
