function [Pval] = ResidScan(Resid, FWHM)
...
% INPUT:
%
% Resid - Residual time courses  (voxel x timecourse)
...
%
% Edited by ML on 07/12/24

num_vox = size(Resid,1);
%num_time = size(Resid,2);

Pval = zeros(num_vox,1);
