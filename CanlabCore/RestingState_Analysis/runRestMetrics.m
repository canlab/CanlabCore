...
%   'HighCutoff_ALFF'      – high cutoff for ALFF (Hz)   (default: 0.1)
%   'LowCutoff_ALFF'       – low cutoff for ALFF (Hz)    (default: 0.01)
...
%   'Band_ReHo'            – ReHo bandpass [low high] Hz (default: [0.01 0.08])
