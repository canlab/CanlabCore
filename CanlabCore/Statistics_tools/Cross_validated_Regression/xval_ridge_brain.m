function pmodel_obj = xval_ridge_brain(my_outcomes, imgs, varargin)
    %pmodel_obj = xval_ridge_brain(my_outcomes, imgs, varargin)
    %
    % PCA-Ridge based prediction on a set of brain images
    % Tor Wager, Sept. 2009
    %
    %
    % Optional inputs:
