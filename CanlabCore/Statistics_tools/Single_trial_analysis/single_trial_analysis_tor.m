function single_trial_analysis_tor(EXPT,onsets,eventdesign,submat,basistype,hipass,varargin)
    ...
    for i = 1:length(varargin)
        if ischar(varargin{i})
            ...
            switch varargin{i}
                case {'start', 'startslice'}, startslice = varargin{i+1};
                ...
                case {'conditioncontrasts'}, conditioncontrasts = varargin{i+1};
                    ...
                    case {'mvmt','movement'}, mvmt =  varargin{i+1};
    ...
    for s = submat;
        ...
        if exist('mvmt', 'var')
            ...
            if size(mvmt, 1) ~= size(img_names, 1)
