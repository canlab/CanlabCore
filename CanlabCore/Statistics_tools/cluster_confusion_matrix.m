...
% :Examples:
% ::
%   Basic analysis on random data - this is effectively what is done on for
%   permutation tests:
%
...
%
%   Full analysis with ward linkage - bootstrap CI, permutation test for inference, and plot of results:
%   [k,stats] = cluster_confusion_matrix(pred_label,test_label,'labels',categories,'dofig','method','ward','perm','bootstrap');
