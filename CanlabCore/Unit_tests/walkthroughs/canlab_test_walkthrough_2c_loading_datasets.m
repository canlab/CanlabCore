...
%CANLAB_TEST_WALKTHROUGH_2C_LOADING_DATASETS Hardened smoke test: Loading datasets walkthrough.
%
% Tier B integration test. Runs a frozen snapshot of the CANlab_help_examples
% walkthrough "canlab_help_2c_loading_datasets" through the headless, fault-tolerant
...
tc.TestData.snapshot = fullfile(here, 'private', 'canlab_help_2c_loading_datasets.m');
end
