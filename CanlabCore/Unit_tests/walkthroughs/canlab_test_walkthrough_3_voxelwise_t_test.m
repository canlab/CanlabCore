...
%CANLAB_TEST_WALKTHROUGH_3_VOXELWISE_T_TEST Hardened smoke test: Voxelwise t-test walkthrough.
%
% Tier B integration test. Runs a frozen snapshot of the CANlab_help_examples
% walkthrough "canlab_help_3_voxelwise_t_test_walkthrough" through the headless, fault-tolerant
...
tc.TestData.snapshot = fullfile(here, 'private', 'canlab_help_3_voxelwise_t_test_walkthrough.m');
end
