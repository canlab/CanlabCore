...
%CANLAB_TEST_WALKTHROUGH_3B_ATLASES_AND_ROI Hardened smoke test: Atlases and ROI analysis walkthrough.
%
% Tier B integration test. Runs a frozen snapshot of the CANlab_help_examples
% walkthrough "canlab_help_3b_atlases_and_ROI_analysis" through the headless, fault-tolerant
...
tc.TestData.snapshot = fullfile(here, 'private', 'canlab_help_3b_atlases_and_ROI_analysis.m');
end
