...
%CANLAB_TEST_WALKTHROUGH_4_MASKING_AND_WRITING Hardened smoke test: Masking and writing NIfTI files walkthrough.
%
% Tier B integration test. Runs a frozen snapshot of the CANlab_help_examples
% walkthrough "canlab_help_4_masking_and_writing_nifti_files" through the headless, fault-tolerant
...
tc.TestData.snapshot = fullfile(here, 'private', 'canlab_help_4_masking_and_writing_nifti_files.m');
end
