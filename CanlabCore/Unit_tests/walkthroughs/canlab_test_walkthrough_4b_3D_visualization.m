...
%CANLAB_TEST_WALKTHROUGH_4B_3D_VISUALIZATION Hardened smoke test: 3D visualization walkthrough.
%
% Tier B integration test. Runs a frozen snapshot of the CANlab_help_examples
% walkthrough "canlab_help_4b_3D_visualization" through the headless, fault-tolerant
...
tc.TestData.snapshot = fullfile(here, 'private', 'canlab_help_4b_3D_visualization.m');
end
