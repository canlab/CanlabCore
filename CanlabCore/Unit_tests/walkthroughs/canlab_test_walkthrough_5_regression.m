function tests = canlab_test_walkthrough_5_regression
%CANLAB_TEST_WALKTHROUGH_5_REGRESSION Hardened smoke test: Regression walkthrough.
%
% Tier B integration test. Runs a frozen snapshot of the CANlab_help_examples
% walkthrough "canlab_help_5_regression_walkthrough" through the headless, fault-tolerant
...
tc.TestData.snapshot = fullfile(here, 'private', 'canlab_help_5_regression_walkthrough.m');
end
