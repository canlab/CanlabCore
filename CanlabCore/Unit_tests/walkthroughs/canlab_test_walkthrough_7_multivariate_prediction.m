...
%CANLAB_TEST_WALKTHROUGH_7_MULTIVARIATE_PREDICTION Hardened smoke test: Multivariate prediction basics walkthrough.
%
% Tier B integration test. Runs a frozen snapshot of the CANlab_help_examples
% walkthrough "canlab_help_7_multivariate_prediction_basics" through the headless, fault-tolerant
...
tc.TestData.snapshot = fullfile(here, 'private', 'canlab_help_7_multivariate_prediction_basics.m');
end
