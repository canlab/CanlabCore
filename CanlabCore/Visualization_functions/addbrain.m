...
%
%   **'subcortex':**
%        SUIT brainstem/cerebellum, thal, BG, amygdala, hippocampus
%
%   **'foursurfaces':**
...
switch meth
    ...
    case {'vmpfc' 'nacc' 'BST' ...
            ...
            'pbn' 'lc' 'rvm' 'rvm_old' 'nts' 'sc' 'ic' 'drn' 'mrn' ...
            'thalamus' 'thal' 'LGN' 'lgn' 'MGN' 'mgn' 'VPthal', 'VPLthal', 'VPL', 'intralaminar_thal', ...
            'medullary_raphe' 'spinal_trigeminal' 'nuc_ambiguus' 'dmnx_nts' 'ncs_B6_B8' 'nrp_B5' 'ncf' 'vep', 'putamen', 'gp', 'globus pallidus'}
    ...
    case 'subcortex'
        ...
        p = addbrain('suit brainstem');
        p = [p addbrain('thalamus')];
        p = [p addbrain('bg')];
        p = [p addbrain('amygdala')];
        p = [p addbrain('hipp')];
