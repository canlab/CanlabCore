...
atlas_obj = load_atlas('destrieux_fmriprep20');
...
[c_fs_sphere_lh, BcC_MNI2009c_to_fsavg_lh, BcV_MNI2009c_to_fsavg_lh] = spherical_icosahedral_interpolation(sphere_reg_lh.vertices - mean(sphere_reg_lh.vertices), sphere_reg_lh.faces, c_white_lh, freesurfer_sphere_lh.vertices);
...
[c_fs_sphere_rh, BcC_MNI2009c_to_fsavg_rh, BcV_MNI2009c_to_fsavg_rh] = spherical_icosahedral_interpolation(sphere_reg_rh.vertices, sphere_reg_rh.faces, c_white_rh, freesurfer_sphere_rh.vertices);
...
for target_vx = 1:size(BcC_fsavg_to_fslr32_lh,1)
    MNI_vx = BcV_MNI2009c_to_fsavg_lh(BcV_fsavg_to_fslr32_lh(target_vx,:),:);
    MNI_weights = BcC_MNI2009c_to_fsavg_lh(BcV_fsavg_to_fslr32_lh(target_vx,:),:).*BcC_fsavg_to_fslr32_lh(target_vx,:)';
...
for target_vx = 1:size(BcC_fsavg_to_fslr32_rh,1)
    MNI_vx = BcV_MNI2009c_to_fsavg_rh(BcV_fsavg_to_fslr32_rh(target_vx,:),:);
    MNI_weights = BcC_MNI2009c_to_fsavg_rh(BcV_fsavg_to_fslr32_rh(target_vx,:),:).*BcC_fsavg_to_fslr32_rh(target_vx,:)';
...
descrip = 'this struct provides vertices indexed into CanlabCore/canlab_canonical_brains/Canonical_brains_surfaces/MNI152NLin2009cAsym_sphere.reg_lh.mat (a freesurfer generated surface reconstruction of MNI152NLin2009cAsym) and associated weights to remap vertices into HCP''s fs_LR 32k template space.';
resample_from_MNI152NLin2009cAsym_to_fsavg_164k = struct('weights_lh', BcC_MNI2009c_to_fsavg_lh, 'vertices_lh', BcV_MNI2009c_to_fsavg_lh, 'weights_rh', BcC_MNI2009c_to_fsavg_rh, 'vertices_rh', BcV_MNI2009c_to_fsavg_rh, 'description', descrip);
...
save('/home/bogdan/.matlab/canlab/CanlabCore/CanlabCore/canlab_canonical_brains/Canonical_brains_surfaces/resample_from_MNI152NLin2009cAsym_to_fsLR_32k.mat', 'resample_from_MNI152NLin2009cAsym_to_fsLR_32k');
save('/home/bogdan/.matlab/canlab/CanlabCore/CanlabCore/canlab_canonical_brains/Canonical_brains_surfaces/resample_from_MNI152NLin2009cAsym_to_fsavg_164k.mat', 'resample_from_MNI152NLin2009cAsym_to_fsavg_164k');