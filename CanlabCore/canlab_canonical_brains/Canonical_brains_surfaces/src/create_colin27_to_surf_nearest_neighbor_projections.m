...
src_img = atlas_obj.select_atlas_subset(33);
tic;
...
[c_fs_sphere_lh, BcC_c27_to_fsavg_lh, BcV_c27_to_fsavg_lh] = spherical_icosahedral_interpolation(sphere_reg_lh.vertices - mean(sphere_reg_lh.vertices), sphere_reg_lh.faces, c_white_lh, freesurfer_sphere_lh.vertices,'nearest');
...
[c_fs_sphere_rh, BcC_c27_to_fsavg_rh, BcV_c27_to_fsavg_rh] = spherical_icosahedral_interpolation(sphere_reg_rh.vertices, sphere_reg_rh.faces, c_white_rh, freesurfer_sphere_rh.vertices,'nearest');
...
save('/home/bogdan/.matlab/canlab/CanlabCore/CanlabCore/canlab_canonical_brains/Canonical_brains_surfaces/resample_from_colin27_to_fsLR_32k_nearestneighbor.mat', 'resample_from_colin27_to_fsLR_32k');
save('/home/bogdan/.matlab/canlab/CanlabCore/CanlabCore/canlab_canonical_brains/Canonical_brains_surfaces/resample_from_colin27_to_fsavg_164k_nearestneighbor.mat', 'resample_from_colin27_to_fsavg_164k');