	...
	double *alpha, Solver::SolutionInfo* si)
{
	...
	//mexPrintf("alphas at upper bound=%d %f %f %d \n",n,param->nu*prob->l,param->nu,prob->l);
	for(i=0;i<n;i++)
		alpha[i] = 1;
	if(n<prob->l)
...
svm_model *svm_train(const svm_problem *prob, const svm_parameter *param)
{
	...
	model->free_sv = 0;	// XXX
	memcpy(&model->param ,param,sizeof(param));

	//mexPrintf("3 SVM_TRAIN: %d %f \n",prob->l ,param->nu);
