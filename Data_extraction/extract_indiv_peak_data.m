...
% and save average timecourses for each individual ROI for each subjec
%
% cl is a clusters structure with one element per region.  Each element
% (cluster) is a structure containing coordinates and data.
%
% imgs is a string matrix with one row per subject, with names of images
